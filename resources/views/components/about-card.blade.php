{{-- @include('partials._everyPageHero') --}}
<!-- About Start -->
  ...
  <div class="container">
    <div class="row g-5">
      ...
      <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
        ...
        {{-- Check if the current route is 'about' or not --}}
        @if ($routeName == 'about')
         <a class="btn btn-primary py-3 px-5 mt-2" href="/courses/allCourses">Start My Learning</a>
        @else
